  ...
  return (
    <div className="relative min-h-screen bg-gradient-to-b from-[#000016] to-[#0a0a1f] text-white overflow-hidden">
      ...
      <main className="container mx-auto flex flex-col items-center justify-center text-center pt-32 2xl:pt-48 px-4">
        <h1 className="text-7xl sm:text-9xl font-black uppercase">
          ARCS
        </h1>
        <p className="mt-6 text-2xl sm:text-4xl uppercase tracking-wider">
      ...
      <Marquee rotate={-4} bottom="5%" left="0%" width="100%" />
      <Marquee rotate={3} bottom="4%" left="0%" width="100%" />
    </div>
  );
}